...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("gep", "Evolver self-evolution: sync sessions, run analysis, manage genes", "Tools & Skills",
               cli_only=True, args_hint="[sync|analyze|recall|record|status]",
               subcommands=("sync", "analyze", "recall", "record", "status", "genes", "cycles"),
               aliases=("evolution", "evolve")),
    CommandDef("reload", "Reload .env variables into the running session", "Tools & Skills"),
    # agent-skills lifecycle commands (Phase B)
    CommandDef("spec", "Define what to build — write a spec/PRD before any code", "Development Lifecycle",
               aliases=("spec-driven-development",)),
    CommandDef("plan", "Plan how to build it — decompose specs into executable tasks", "Development Lifecycle",
               aliases=("planning-and-task-breakdown",)),
    CommandDef("build", "Build incrementally — thin vertical slices, early and often", "Development Lifecycle",
               aliases=("incremental-implementation",)),
    CommandDef("test", "Prove it works — tests are living documentation of behavior", "Development Lifecycle",
               aliases=("test-driven-development",)),
    CommandDef("review", "Review before merge — improve code quality and catch issues early", "Development Lifecycle",
               aliases=("code-review-and-quality",)),
    CommandDef("ship", "Ship to production — deploy, monitor, and validate", "Development Lifecycle",
               aliases=("shipping-and-launch",)),
    CommandDef("code-simplify", "Simplify the code — clarity over cleverness, delete dead code", "Development Lifecycle",

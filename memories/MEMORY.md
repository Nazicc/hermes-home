...
§
[VERIFIED · 2026-05-26] animus 0.8.0-beta 全流程验证通过：DeepSeek(deepseek-v4-flash)✅, MCP 11 tools registered ✓, Companion "Kai"(fox)✅存档于 grok-animus/Kai.json。Skills双备份已更新真实工具名。
§
[FIXED · 2026-05-26] agent/async_utils.py 缺失导致 `hermes mcp` 出现 RuntimeWarning 和 ImportError。修复：从上游 commit 4e89c5308 提取 async_utils.py 恢复到 agent/ 目录，`hermes mcp test` 告警已完全消除。
...
description: >-
  Debug and test web applications using browser DevTools — network inspection, breakpoint debugging, console analysis. Use when debugging browser issues, network requests, or frontend bugs.
trigger:
  - "devtools"
  - "browser debug"
  - "network tab"

...
description: >-
  Build production-quality UI components — accessibility, responsive design, animation best practices, component patterns. Use when building UI components or frontend features.
trigger:
  - "ui"
  - "frontend"
  - "component"

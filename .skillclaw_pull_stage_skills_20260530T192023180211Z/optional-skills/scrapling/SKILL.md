---
name: scrapling
description: "Web scraping with Scrapling - HTTP fetching, stealth browser automation, Cloudflare bypass, and spider crawling via CLI and Python. Use when: you need to scrape websites, bypass Cloudflare protection, automate browser-based data extraction, or crawl spider-based websites. NOT for: API-based data access, sites with login requirements you cannot bypass, or large-scale distributed crawling infrastructure."

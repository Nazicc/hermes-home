---
name: nemo-curator
description: "Use when curating, filtering, or deduplicating datasets for LLM training with GPU acceleration. Supports text/image/video/audio with fuzzy deduplication (16× faster), quality filtering (30+ heuristics), semantic deduplication, PII redaction, and NSFW detection. Scales across GPUs with RAPIDS. Use for preparing high-quality training datasets, cleaning web data, or deduplicating large corpora. NOT for: model training, inference, or non-LLM data processing."

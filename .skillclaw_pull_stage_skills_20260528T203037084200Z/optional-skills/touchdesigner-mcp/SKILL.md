...
description: "Control a running TouchDesigner instance via twozero MCP — create operators, set parameters, wire connections, execute Python, build real-time visuals. 36 native tools. Use when: real-time visual programming, generative art, audio-reactive installations, or interactive media server control. NOT for: non-TouchDesigner workflows, offline rendering, or when creative coding frameworks like Processing/p5.js would be more appropriate."

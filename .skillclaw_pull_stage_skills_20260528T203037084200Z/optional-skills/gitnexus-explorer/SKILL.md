...
description: "Use when indexing a codebase with GitNexus and serving an interactive knowledge graph via web UI + Cloudflare tunnel for exploring large codebases, understanding code relationships, or visual navigation. NOT for: code execution, git operations, security scanning, or when IDE-based navigation is more efficient."

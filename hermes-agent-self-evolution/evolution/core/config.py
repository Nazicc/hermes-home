...
class EvolutionConfig:
    ...
    # LLM configuration
    optimizer_model: str = "openai/deepseek-v4-pro"  # Model for GEPA reflections
    eval_model: str = "openai/deepseek-v4-flash"  # Model for LLM-as-judge scoring
    judge_model: str = "openai/deepseek-v4-pro"  # Model for dataset generation
